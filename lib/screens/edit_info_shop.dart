...
class _EditInfoShopState extends State<EditInfoShop> {
  ...
  Future<Null> readCurrentInfo() async {
    ...
    String url =
        '${MyConstant().domain}getUserWhereUserId.php?isAdd=true&id=$idShop';
    //print('url ==>> $url');
  ...
  Future<Null> editThread() async {
    ...
    await Dio().post(urlUpload, data: formData).then((value) async {
      ...
      String url =
          '${MyConstant().domain}editUserWhereId.php?isAdd=true&id=$id&NameShop=$nameShop&Address=$address&Phone=$phone&UrlPicture=$urlPicture&Lat=$lat&Lng=$lng';
