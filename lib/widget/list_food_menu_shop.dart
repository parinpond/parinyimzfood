...
import 'package:parinyimzfood/screens/add_food_menu.dart';
import 'package:parinyimzfood/screens/edit_food_menu.dart';
            ...
            children: <Widget>[
              FlatButton(
                onPressed: () async {
                  ...
                  String url =
                      '${MyConstant().domain}deleteFoodWhereId.php?isAdd=true&id=${foodModel.id}';
