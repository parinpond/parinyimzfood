...
import 'package:parinyimzfood/screens/add_info_shop.dart';
import 'package:parinyimzfood/screens/edit_info_shop.dart';
...
class _InfomationShopState extends State<InfomationShop> {
  ...
  Future<Null> readDataUser() async {
    ...
    String url =
        '${MyConstant().domain}getUserWhereUserId.php?isAdd=true&id=$id';
    //print('url = $url');
